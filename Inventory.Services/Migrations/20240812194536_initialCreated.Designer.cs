...
namespace Inventory.Services.Migrations
{
    ...
    [Migration("20240812194536_initialCreated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Models.NumberSquence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Models.Shippment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("ShippingmentDate")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("ShippinmentName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Inventory.Models.UserProfile", b =>
                {
                    b.HasOne("Inventory.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Models.PurchaseOrder", b =>
                {
                    b.Navigation("purchasesOrderLines");
                });
